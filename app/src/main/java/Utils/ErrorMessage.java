...
public class ErrorMessage {
	...
	public static final String notUserFound = "El usuario no existe";
	public static final String notUserValidCredentials = "Credenciales inválidas";

	public static final String INVALID_CREDENTIALS = "invalid credentials";
	public static final String NON_FIELD_ERRORS = "non_field_errors";
	public static final String INNACTIVE_ACCOUNT = "Inactive account.";
